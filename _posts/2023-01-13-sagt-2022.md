...
EF1 on the other hand is possible in a variety of settings: when agents have weakly additive utilities the round robin algorithm finds a complete EF1 allocation, and in the more general case when agents have increasing utilities envy-cycle elimination finds a complete EF1 allocation.
...
[^8]: The empty allocation $$(\emptyset, \emptyset, \ldots, \emptyset)$$ is trivially EF but we are interested in finding allocations that are somewhat efficient.
